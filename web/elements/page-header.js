...
template.innerHTML = /*html*/`
    <style>
		...
		.icon-color { background-color: var(--secondary-fn-color);}
		.icon-color:hover { background-color: var(--nike-yellow);}

		.menu, .nav-menu {float:right;padding-right: 32px;}
	...
	<header>
		<h1>Web Template <span id="pageTitle"></span></h1>
		<nav class="menu">
	        <a href="/"><span class="icon icon-32 icon-home icon-color"></span></a>
